                    ...
                    submit === true ? (
                        <>
                            <div className="mx-auto max-w-2xl text-center">
                                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Address Details</h2>
                            </div>
                            <form action="#" onSubmit={submitHandler} className="mx-auto mt-16 max-w-xl sm:mt-20">
                        ...
                        <div className="mx-auto max-w-2xl text-center">
                            <h5 className="text-xl font-bold tracking-tight text-gray-900 sm:text-4xl">Thank you, you will receive your order in few days!</h5>
                        </div>
                    )
                }
            </div>
